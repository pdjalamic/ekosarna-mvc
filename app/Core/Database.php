...
class Database
{
    ...
    public static function migrate(): void
    {
        ...
        $db->exec("CREATE TABLE IF NOT EXISTS admin_korisnici (
            ...
            uloga           ENUM('Direktor','AT','AF','Inženjer na gradilištu','Pomoćni radnik','Administrator','Operater','Elektricar') NOT NULL DEFAULT 'Operater',
        ...
        $alters = [
            ...
            "ALTER TABLE admin_korisnici MODIFY COLUMN uloga ENUM('Direktor','AT','AF','Inženjer na gradilištu','Pomoćni radnik','Administrator','Operater','Elektricar') NOT NULL DEFAULT 'Operater'",
