...
class Database
{
    ...
    public static function migrate(): void
    {
        ...
        $db->exec("CREATE TABLE IF NOT EXISTS admin_korisnici (
            ...
            uloga           ENUM('Administrator','Operater','Elektricar') NOT NULL DEFAULT 'Operater',
        ...
        $alters = [
            ...
            "ALTER TABLE admin_korisnici MODIFY COLUMN uloga ENUM('Administrator','Operater','Elektricar') NOT NULL DEFAULT 'Operater'",
