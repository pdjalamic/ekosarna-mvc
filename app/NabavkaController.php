...
class NabavkaController extends \Core\Controller
{
    ...
    public function index(): void
    {
        ...
        if ($je_kancelarija) {
            $radnici = $this->db->query("SELECT id, ime FROM admin_korisnici WHERE aktivan=1 ORDER BY ime ASC")->fetchAll(\PDO::FETCH_ASSOC);
        }
        ...
        $this->view('nabavka/index', compact(
            ...
            'filter_status', 'filter_grad', 'filter_radnik', 'filter_od', 'filter_do',
